...
| Dummy API (CRUD, Auth)       | daniwebdev               | [Link](https://json.web.id)                           | ✅     | Dummy API untuk uji coba atau sekedar belajar. Dummy API ini bisa melkukan CRUD maupun Autentikasi seperto login & register  | `false`     |
